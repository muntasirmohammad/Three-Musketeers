...
public class HumanAgent extends Agent {
    ...
    private Cell getFromCell(List<Cell> possibleCells) {
        ...
        Coordinate fromCoordinate = getCoordinate(pieceMessage, board.size);
    ...
    private Cell getToCell(List<Cell> possibleDestinations) {
        ...
        Coordinate toCoordinate = getCoordinate(toCoordinateMessage, board.size);
    ...
    public static Coordinate getCoordinate(String message, int size) {
        System.out.print(message);
        Scanner scanner = new Scanner(System.in);
        String coordinateStr = scanner.nextLine();
        try {
            return Utils.parseUserMove(coordinateStr.strip().toUpperCase(), size);
        } catch (InvalidMoveException e) {
            System.out.println(e.getMessage());
            return getCoordinate(message, size);
        }
    }
}
